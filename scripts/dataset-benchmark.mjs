...
console.log(`Dentiva Pro v${APP_VERSION} domain benchmark; synthetic records are never written to the application store.`);
for (const size of sizes) {
  ...
  const manifest = buildBackupManifest(state, APP_VERSION, ARRAY_COLLECTIONS);
